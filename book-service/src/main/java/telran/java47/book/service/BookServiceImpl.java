...
public class BookServiceImpl implements BookService {
	...
	public boolean addBook(BookDto bookDto) {
		...
		Set<Author> authors = bookDto.getAuthors().stream()
				...
				.orElse(authorRepository.save(new Author(a.getName(), a.getLocalDate()))))
	...
	@Override
	public BookDto findBookByIsbn(String isdn) {
		Book book = bookRepository.findById(isdn).orElseThrow(EntityNotFoundException::new);
