...
class CompanyTest {
	...
	void findEmployeesHoursGreaterThan() {
		Employee[] acttual = company.findEmployeesHoursGreaterThan(100);
		Employee[] expected = {firm[0],firm[1],firm[2]};
		assertArrayEquals(expected, acttual);
		
	}
	
	@Test
	void findEmployeesSalaryBetween() {
		Employee[] acttual = company.findEmployeesSalaryBetween(5000,10000);
